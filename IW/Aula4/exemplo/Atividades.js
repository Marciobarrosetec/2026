...
function exercicio1(){
    ...
    if (numero1 % 2 === 0) {
        mostrarResultado("O número: "+ "  " + numero1 + " é par.");
    } else {
        mostrarResultado("O número" + numero1 + " é impar.");
...
function exercicio2(){
    ...
    if (idade >= 18) {
        mostrarResultado("Você é maior de idade.");
    } else {
        mostrarResultado("Você é menor de idade.");
    }
}
